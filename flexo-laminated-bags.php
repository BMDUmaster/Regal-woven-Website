            ...
            <div class="row">
                <div class="col-12">
                    <div class="wrap_breadcrumbs_1">
                        <h1 class="breadcurmbs-head" data-aos="fade-up"> Bopp Flexo Laminated Bags</h1>
                        <ul class="breadcrumbs_content_1" data-aos="fade-up" data-aos-delay="100">
                            <li><a href="index.php" title="home"> Home </a> /</li>
                            <li><span>Bopp Flexo Laminated Bags</span></li>
                        </ul>
                    </div>
                </div>
            </div>
                ...
                <div class="container">
                    <div class="content-section">
                        <div class="row align-items-center">
                            <!-- Image Carousel (Left) -->
                            <div class="col-lg-6" data-aos="fade-right">
                                <img src="images\blog1.jpg" alt="POF Shrink Film" class="custom-image mt-0">
                            </div>
                            ...
                            <div class="col-lg-6 d-flex flex-column" data-aos="fade-left">
                                ...
                                <div class="d-flex align-items-center flex-grow-1">
                                    <div>
                                        <p data-aos="fade-up" data-aos-delay="100">We can offer FLEXO bags with PP multicolor printed and laminated on single side as well as both sides.
                                            bulk packaging for 5 kg to 75 kg packs.</p>
                                        <p data-aos="fade-up" data-aos-delay="150">Her at Regal,we also offers high-qualityflexo printing at a low cost.</p>
                                        <p data-aos="fade-up" data-aos-delay="200">The best thing about this particular type of printing is that it can be printed on coated and uncoated bags as well.</p>
                                    </div>
                                </div>
                            </div>
                        </div>

                        <h6 class="mb-4" data-aos="fade-up">Product Details.</h6>
