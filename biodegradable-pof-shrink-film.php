            ...
            <div class="row">
                <div class="col-12">
                    <div class="wrap_breadcrumbs_1">
                        <h1 class="breadcurmbs-head">Biodegradable polyolefin Shrink Film (POF)</h1>
                        <ul class="breadcrumbs_content_1">
                            <li><a href="index.php" title="home"> Home </a> /</li>
                            <li><span>Biodegradable polyolefin Shrink Film (POF)</span></li>
                        </ul>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-12 col-md-8" data-aos="fade-right">
                        <div class="industry-box">
                            <h5 class="fw-bold mb-3">
                                ...
                                Government Exemption under ERP for &lt;50 Micron Shrink Film
                            </h5>
                            <p>
                                According to India’s Plastic Waste Management Rules, biodegradable packaging films below
                                50 microns
                                may be exempt from plastic bans or EPR obligations—if certified by the CPCB (Central
                                Pollution Control Board).
                            </p>
                            <p>
                                At Regal Woven Sacks LLP, our biodegradable POF films are developed with this regulation
                                in mind, helping you
                                stay compliant while adopting greener practices.
                            </p>
                        </div>
                    </div>
                </div>
